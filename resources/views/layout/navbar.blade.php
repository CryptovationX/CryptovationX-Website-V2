<nav id="home" class="navbar navbar-default navbar-dark fixed-top navbar-shadow navbar-expand-lg padding-0 header-nav">
  <div class="container">
    <a class="navbar-brand-mat" href="#">
      <img src="https://s3-ap-southeast-1.amazonaws.com/cryptovationx/public/logos/Token3.png" class="img-fluid" alt="Responsive image" height="50px" width="50px">
    </a>
