	...
	<a>
		...
		<div class="row">
			<div class="col-sm-12 text-small text-center">
				...
				<br>
				<a class="company  mb20 descipt-people descipt-people bio " href="/terms-conditions">Terms and Conditions</a><p class="no-margin copyright">&copy; 2018 CryptovationX Inc. All Right Reserved</p>
			</div>
			<!-- /.column -->
		</div>
		<!-- /.row -->
