...
<footer style="background-color: transparent">
    <div class="row">
        <div class="col-5">
                <a href="https://cryptovationx.io" target="_blank"><img src="{{ asset('images/fulltoplogo.png') }}" class="footer_logo"></a>
            ...
            <h2 class="theme-title">Particles
                ...
                <i class="fab fa-slack-hash social-icons-dark-hover   mfooter"></i>
            </a> -->
        
                        <!-- <a>
                <i class="fab fa-google-plus social-icons-dark-hover   mfooter"></i>
            </a> -->
                        ...
                        <!-- <a href="#" target="_blank">
                            <span class="fab fa-instagram social-icons-dark-hover   mfooter"></span>
                        </a> -->
                        <!-- <a>
                    <i class="fa-reddit-alien social-icons-dark-hover   mfooter"></i>
            </a>
            <a>
        ...
        <div class="col-1"></div>
        <div class="col-2 footer_column">
            <div style="padding-bottom:15px;">Product</div>
            <div style="padding-bottom:5px;"><a target="_blank" href="https://arbot.cryptovation.co/liveprices">Live Price</a></div>
            <div style="padding-bottom:5px;"><a target="_blank" href="https://arbot.cryptovation.co/oneways/btc">One-way</a></div>
            <div><a target="_blank" href="https://arbot.cryptovation.co/loops/btceth">Loop</a></div>
        </div>
        <div class="col-2 footer_column">
            <div style="padding-bottom:15px;">About</div>
            <div style="padding-bottom:5px;"><a target="_blank" href="https://arbot.cryptovation.co/">Arbot Terminal</a></div>
            <div style="padding-bottom:5px;"><a target="_blank" href="http://ava.fund/">AVA Advisor</a></div>
            <div><a target="_blank" href="https://cryptovationx.io/whitepaper.pdf">White Paper</a></div>

        </div>
        <div class="col-2 footer_column">
            <div style="padding-bottom:15px;">Agreement</div>
            <div><a target="_blank" href="https://cryptovationx.io/terms-conditions">Terms & Conditions</a></div>
        </div>
    </div>
