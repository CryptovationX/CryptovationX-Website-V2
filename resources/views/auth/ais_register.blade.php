    ...
    <div class="container">
        ...
        <div class="row" style="padding: 0% 10% 0 10%">
            <div class="container" style="padding: 0% 5% 0 5%">
                ...
                <div class="row">
                    <div class="col-md-6" style="padding-top: 2%">
                        <input type="text" name="facebook" placeholder="Facebook (Profile Link)" style="background-color:transparent;" class="input" v-model="facebook" pattern="^(http|https)://www.f" data-parsley-pattern-message="Format 'https://www.facebook.com/{your_id}'" required>
                    </div>
                </div>                   
